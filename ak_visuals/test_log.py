...
final visuals layer, the camera will somehow communicate the transform
...
class LogCamera(visuals.TwoDCamera):
    # Does nothing, but the idea is that it defines the kind of transform
    

class PointsVisual(visuals.PointsVisual):
...
points = PointsVisual(fig.world, data)
